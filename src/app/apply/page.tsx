      ...
      <div className=" bg-blue-100 w-2/3 h-auto m-10 p-2 shadow-[-10px_10px_5px_rgba(0,0,0,0.25)] ">
        <div className="flex flex-col items-center p-2">
          ...
          <div className=" flex gap-5 items-center ">
            ...
            <p className="text-sm text-center border-2 border-black rounded-full p-2">CHANGE</p>
          </div>
        </div>
        ...
        <div className=" w-full h-auto flex ">
          {/* Leftside */}
          <div className=" w-1/2 pr-4"> {/* ปรับ width และเพิ่ม padding ขวา */}
            {/* Name Field */}
            <div className="m-4 mb-4">
              <h1 className = "text-primary font-bold text-base font-primary tracking-wide" >Name</h1>
            ...
            {/* Nickname Field */}
            <div className="m-4 mb-4">
              <h1 className = "text-primary font-bold text-base font-primary tracking-wide" >Nickname</h1>
              <div className="relative">
                <input
                  type="text"
            ...
            {/* Grade Field */}
            <div className="m-4 mb-4"> {/* เพิ่ม margin-bottom */}
              <h1 className = "text-primary font-bold text-base font-primary tracking-wide" >Grade</h1>
              <div className="relative">
                <input
                  type="text"
                  placeholder="Grade"
            ...
            {/* Cost Field */}
            <div className="m-4 mb-4">
              <h1 className = "text-primary font-bold text-base font-primary tracking-wide" >Cost</h1>
              <div className="relative">
                <input
                  type="text"
            ...
            {/* Subject Field */}
            <div className="m-4 mb-4">
              <h1 className = "text-primary font-bold text-base font-primary tracking-wide" >Subjects to be tutor</h1>
              <div className="relative">
                <select
                  className="pl-2 pr-4 py-3 border-2 border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 w-full"
                >
                  ...
                  {/* เพิ่มตัวเลือกวิชาอื่นๆ ได้ตามต้องการ */}
                </select>
              </div>
            </div>
          </div>
          ...
          <div className="relative w-1/2 pl-4">
            ...
            <div className="mr-6 mb-4 mt-4">
              <h1 className = "text-primary font-bold font-primary tracking-wide" >Tutor Experience</h1>
              <div >
                <textarea
            ...
            {/* date and time Field */}
            <div className="mr-6 mb-4 mt-4"> {/* เพิ่ม margin-bottom */}
              <h1 className = "text-primary font-bold text-base font-primary tracking-wide" >Convenient Day and Time</h1>
              <input 
                    type="datetime-local"
